...
def main():
    ...
    ap.add_argument("--limit", type=int, default=int(os.getenv("UNIVERSE_LIMIT", "100")))
    ap.add_argument("--start", default="2022-01-01")
    ap.add_argument("--end", default=None, help="YYYY-MM-DD; default: today")

    # Full config (you can override from CLI)
    ap.add_argument("--max_positions", type=int, default=5)
    ap.add_argument("--total_capital", type=float, default=100000.0)
    ap.add_argument("--max_invested", type=float, default=50000.0)
    ap.add_argument("--max_risk", type=float, default=2000.0, help="Max risk per trade (₹)")
